 ...
 * Routes to V2 (message_headers) or V1 (portal_messages) builder based on trace_version.
 */
...
/**
 * V2: IRIS-convention per-leg trace (message_headers).
...
/**
 * V1: Legacy portal_messages format (read-only for historical data).
 */
