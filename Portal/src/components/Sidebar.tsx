  ...
  return (
    <div className={`flex h-full flex-col p-4 transition-all duration-300 ${collapsed ? 'w-16' : 'w-64'}`}>
      ...
      <div className="mb-6">
        ...
        >
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-blue-500 via-cyan-500 to-teal-500 flex-shrink-0">
            <span className="text-white text-sm font-bold">H</span>
          </div>
          {!collapsed && (
            <div className="overflow-hidden">
              <div className="text-sm font-semibold text-gray-900 dark:text-white">HIE Portal</div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400">Healthcare Integration</div>
            </div>
          )}
          {!collapsed && (
      ...
      <div className="mt-auto border-t border-gray-200 dark:border-zinc-700 pt-4">
        <div className="rounded-lg bg-gray-50 dark:bg-zinc-700 p-3">
          {!collapsed ? (
            <>
              <div className="text-xs font-medium text-gray-900 dark:text-white">HIE v{VERSION}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Healthcare Integration</div>
            </>
          ) : (
