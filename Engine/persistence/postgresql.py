...
from Engine.core.message import Message, MessageState
from Engine.persistence.base import MessageStore, StateStore, MessageQuery
...
class PostgreSQLMessageStore(MessageStore):
    ...
    def _row_to_message(self, row: asyncpg.Record) -> Message:
        ...
        from Engine.core.message import Envelope, Payload, Property
