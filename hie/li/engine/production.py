...
from hie.li.config import IRISXMLLoader, ProductionConfig, ItemConfig
...
from hie.li.registry import ClassRegistry
from hie.li.persistence import WAL, WALConfig, MessageStore
from hie.li.metrics import get_metrics_registry, set_host_status
...
class ProductionEngine:
    ...
    async def _init_infrastructure(self) -> None:
        ...
        if self._config.store_enabled:
            from hie.li.persistence import FileStorageBackend
